...
output_dir_VPC <-"/storage/home/ejm6007/B2AcReLogit50/B2AcReLogit50_VPC"
output_dir_Fits <- "/storage/home/ejm6007/B2AcReLogit50/B2AcReLogit50_Fits"
output_dir_PrmDist <-"/storage/home/ejm6007/B2AcReLogit50/B2AcReLogit50_PrmDist"
...
i=3
  for (j in 1:5){
    for (k in 1:nrow(PrmCombinations)){ # nrow(PrmCombinations)loop for covariates
      loadProject(projectFile="/storage/work/ejm6007/B2AcReLogit50/B2AcReLogit50_3.mlxtran")
      ...
      #save the table
      write.csv(tabestimates, file.path(TablePath, "B2AcReLogit50Covariates3.csv"))
      write.csv(initprmvalues, file.path(TablePath, "B2AcReLogit50CovariatesInitPrm3.csv"))
      write.csv(indivprmvalues, file.path(TablePath, "B2AcReLogit50CovariatesIndivPrm3.csv"))
